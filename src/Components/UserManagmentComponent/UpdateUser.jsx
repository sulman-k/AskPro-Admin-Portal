...
const UpdateUser = () => {
  ...
  const addUser = async (e) => {
    ...
    if (username === authUser().userName || authUser().role[0].role === "Company_Admin") {
      ...
      toast.error("You are only allowed to update yourself");
    }
  };
            ...
            <form id="addEstimatorForm" onSubmit={addUser}>
              ...
              <div className="mt-2">
                ...
                <div className="dropdown ">
                  <Input
                    disabled={authUser().role[0].role !== "Company_Admin" ? true : false}
                    id="role"
                    name="select"
                    className="br10"
